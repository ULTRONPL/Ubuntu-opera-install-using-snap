...
<br>
It should not be any problems with double "%U" in "Exec=" line, but if your language is not loading or you have any other problems try 
<br>
applying the instrutions below it might help you 
<br>
## Flatpack
<br>
